...
function _update_ps1() {
  ...
  PS1=`powerline-go -theme default -shell bash -modules user,cwd,duration -duration $__DURATION -cwd-max-depth 4 -cwd-max-dir-size 20 -error $__ERRCODE`
}
...
export GCLOUD_KEY_PATH=$HOME/shadow/key.json
